...
const Footer = () => {
  return (
    <footer className="border-t border-t-gray-200 py-8 bg-[#353839]"> {/* Added background color */}
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="mb-4 md:mb-0">
            <h2 className="text-xl font-bold text-white">TalentTrove</h2>
            <p className="text-sm text-gray-400">© 2024 Your Company. All rights reserved.</p>
          </div>
          
          <div className="flex space-x-4 mt-4 md:mt-0">
            <a href="https://facebook.com" className="text-[#1877F2] hover:text-gray-400" aria-label="Facebook">
            ...
            <a href="https://twitter.com" className="text-[#1DA1F2] hover:text-gray-400" aria-label="Twitter">
            ...
            <a href="https://linkedin.com" className="text-[#0077B5] hover:text-gray-400" aria-label="LinkedIn">
